  ...
  try {
    const r = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: [emailLower],
        subject: "קוד אימות - DR STOCKS 26",
        html: `
          <div dir="rtl" style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;background:#080c14;color:#e2e8f0;padding:32px;border-radius:16px">
            <div style="text-align:center;margin-bottom:24px">
              ...
              <h1 style="color:#f4b942;margin:8px 0;font-size:24px">DR STOCKS 26</h1>
            ...
            <p style="margin-bottom:24px;color:#94a3b8">קוד האימות שלך ל-DR STOCKS 26:</p>
